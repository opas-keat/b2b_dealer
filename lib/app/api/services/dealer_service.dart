...
import '../../data/models/dealer_response.dart';
...
class DealerService {
  Future<DealerResponse?> getDealerByCode(String dealerCode) async {
    final connectivityResult = await (Connectivity().checkConnectivity());
    if (connectivityResult == ConnectivityResult.none) {
      return DealerResponse.withError(
    ...
    try {
      ...
      if (result.data['status_code'] == 200) {
        return DealerResponse.fromJson(result.data);
      }
      return DealerResponse.withError(statusCode: CODE_RESPONSE_NULL, msg: "");
    } catch (e) {
      return DealerResponse.withError(
